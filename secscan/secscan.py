...
from secscan import settings
from secscan.utils import (
    get_config,
...
class SECScan:
    ...
    def format_output(self, results) -> dict:
        """Format to secscan friendly output."""
    ...
    def suppress_pm_comments(self, obj, rule_id):
        ...
        if 'secscan-ignore:' in match_line and rule_id in match_line:
            return True
        return False
    ...
    def post_ignore_files(self):
        ...
        for rule_id, details in self.result['nodejs'].items():
            ...
            for file in files:
                ...
                if 'secscan-ignore:' in mstr and rule_id in mstr:
