...
from seclyzer.app import app
from seclyzer.models import db
from seclyzer import utils
...
class Tests(unittest.TestCase):
    ...
    def test_view_scan(self):
        """Scan with invalid hash."""
        response = self.app.get(f'/link/scan/{VALID_HASH}', follow_redirects=True)
        self.assertEqual(response.status_code, 200)
